...
새 기능 추가 시, **[docs/MASTER_PRD.md](../../00-overview/MASTER_PRD.md)** 와 **[docs/BLUEPRINT.md](../../00-overview/BLUEPRINT.md)** 를 벗어나는 구조 변경을 절대 금지합니다.
* 예외(Exception)와 에러는 **[docs/02-technical/ERROR_CATALOG.md](../../02-technical/ERROR_CATALOG.md)** 에 한 줄로 요약해 기록하세요.
...
- `src/lib/saju/index.ts`: 일주 계산 / 60갑자 매핑 로직
- `src/components/home/SecretPawsFlow.tsx`: 메인 깔때기 (생년월일 입력 ➔ 결과 ➔ 추천 ➔ 공유/결제)
