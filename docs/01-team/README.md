...
|---|---|---|---|
| Product Planner | 기능 전략/우선순위/릴리즈 판단 | `product/TEAM_SPEC_기획자.md` | `../00-overview/roadmap.md` |
| Designer | UI/UX 정책, 톤/컴포넌트 톤앤매너 | `product/TEAM_SPEC_디자이너.md` | `product/design-system.md` |
| Developer | 화면/로직 구현, 인증/결제/운영 안정성 | `engineering/TEAM_SPEC_개발자.md` | `engineering/` |
| Content Owner | 용어 정합성, 문구/콘텐츠 품질 | `product/TEAM_SPEC_콘텐츠.md` | `../00-overview/execution-backlog-ko.md` |
...
3. Reflect execution status in `docs/archive/decision-history/active-dispatch.md`.
...
- [Engineering Testing Guide](./engineering/testing-guide.md)
