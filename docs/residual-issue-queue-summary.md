...
- `docs/active-dispatch.md`에 Wave30-10 운영 체크 항목으로 반영.
...
- 2026-03-04: docs/active-dispatch.md에 Wave30-12~30-20(221~400) 선점/정합성 검토 완료 항목을 병렬 스냅샷으로 등록.
...
- 다음 액션: `docs/active-dispatch.md`에 Wave30-33(추가 10개 단위) 반영 예정
