                ...
                <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-6 relative z-10">
                    <div className="flex-shrink-0 relative">
                        <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-full border border-white/15 flex items-center justify-center relative overflow-hidden group/gauge">
                            ...
                            <div className="relative z-10 text-center space-y-1">
                                ...
                                <div className="text-[13px] sm:text-[13px] font-black uppercase tracking-[0.24em] text-[color:var(--text-muted)]">조화 지수</div>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 text-center lg:text-left space-y-3 sm:space-y-5">
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
                            <div className="ui-chip text-sm sm:text-[13px]">
                            ...
                            <div className="flex items-center gap-2 text-amber-400 group/help cursor-pointer">
                                ...
                                <span className="text-[13px] sm:text-[13px] font-black uppercase tracking-[0.2em] opacity-70 hover:opacity-100 transition-opacity">현재 최적 채널 감지됨</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 pt-3 sm:pt-4">
                            {[
                                ...
                                <div key={i} className={cn("flex items-center gap-2.5 px-3 py-2 rounded-2xl border border-white/10", stat.color)}>
                                    ...
                                    <span className="text-[13px] font-black uppercase tracking-widest border-l border-white/10 pl-2.5">{stat.label}: <span className="text-white">{stat.val}</span></span>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="pt-2 h-10 w-full max-w-[200px] opacity-40">
                            ...
                            <p className="text-[13px] font-black uppercase tracking-widest text-slate-500 mt-1">실시간 파동 동기화 중...</p>
                        </div>
                    </div>
                </div>
            </div>
