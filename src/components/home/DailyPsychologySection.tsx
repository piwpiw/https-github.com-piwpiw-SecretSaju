                                ...
                                <div className="space-y-2">
                                    ...
                                    {tags.length > 0 ? (
                                        <div className="flex flex-wrap gap-2">
                                            {tags.map((tag) => (
                                                <span key={tag} className="px-2 py-0.5 bg-rose-500/10 border border-rose-500/20 rounded-lg text-[13px] font-black text-rose-400 uppercase tracking-widest">{tag}</span>
                                            ))}
                                        </div>
                                    ) : null}
                                </div>
