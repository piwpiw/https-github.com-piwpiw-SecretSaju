...
export default function CouponBanner() {
  return (
    <section className="px-4 py-6 md:px-6 md:py-10 relative">
      <div className="relative bg-slate-900/60 backdrop-blur-3xl border border-indigo-500/30 rounded-[2rem] p-6 sm:p-5 sm:p-8 md:p-6 sm:p-9 overflow-hidden group shadow-2xl">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-6 relative z-10">
