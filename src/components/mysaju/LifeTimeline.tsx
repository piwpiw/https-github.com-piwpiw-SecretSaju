            ...
            <div className="min-w-[600px] relative">
                ...
                <div className="flex justify-between items-center relative z-10">
                    {MILESTONES.map((m, i) => (
                        ...
                        >
                            <div className={`${m.color} h-2 px-3 flex items-center justify-center rounded-full text-[13px] font-black text-white tracking-widest`}>
                                {m.age}세
                            </div>
                            ...
                            <p className="text-[13px] font-bold text-slate-500 uppercase tracking-tighter whitespace-nowrap group-hover:text-white transition-colors">
                                {m.event}
                            </p>
                        </motion.div>
                    ))}
