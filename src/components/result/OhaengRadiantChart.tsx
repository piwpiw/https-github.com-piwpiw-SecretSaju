    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h3 className="text-[13px] font-black text-indigo-400 uppercase tracking-[0.3em]">오행 균형 분석</h3>
                <div className="text-[13px] text-slate-500 font-bold uppercase tracking-widest bg-white/5 px-2 py-0.5 rounded border border-white/5">실시간 엔진</div>
            </div>
                ...
                {elements.map((el, i) => (
                    <div key={el.name} className="space-y-1.5">
                        <div className="flex items-center justify-between text-[13px] font-black uppercase tracking-widest">
                            ...
                            <span className="text-white">{el.score}점</span>
                        </div>
