    ...
    <div className="flex flex-wrap items-center justify-center gap-2.5">
      {displayTags.map((tag, i) => (
        <motion.div
          ...
          className="px-4 py-1.5 rounded-full border border-white/5 bg-white/5 backdrop-blur-md text-[10px] font-black uppercase tracking-widest flex items-center gap-2 group cursor-default shadow-lg shadow-black/20"
        >
          <div
