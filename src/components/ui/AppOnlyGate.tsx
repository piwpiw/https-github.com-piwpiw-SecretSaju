...
export default function AppOnlyGate({ children, title = "앱 전용 기능" }: { children: React.ReactNode; title?: string }) {
    ...
    return (
        <div className="relative group">
            ...
            <div
                className="absolute inset-0 flex items-center justify-center p-8 bg-black/20 rounded-[2.5rem] backdrop-blur-sm border border-white/5 shadow-2xl scale-95 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-500 cursor-pointer"
