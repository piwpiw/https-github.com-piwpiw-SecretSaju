                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-center gap-2">
                                        ...
                                        <div className={`text-[13px] font-black drop-shadow-[0_0_8px_rgba(34,211,238,0.5)] ${node.analysis && node.analysis.score >= 80 ? 'text-cyan-400' : node.analysis && node.analysis.score >= 50 ? 'text-yellow-400' : 'text-slate-400'}`}>
