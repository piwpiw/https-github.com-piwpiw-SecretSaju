        ...
        <main className="min-h-screen bg-[#050505] text-foreground relative overflow-hidden pb-40">
            ...
            <div className="max-w-4xl mx-auto px-0 sm:px-6 py-8 relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase leading-[0.9] mb-6 break-keep">
                        운명 <span className="text-indigo-400">데이터 로그</span>
                    </h1>
                    <p className="text-slate-400 text-lg font-medium opacity-70 max-w-xl mx-auto break-keep">
