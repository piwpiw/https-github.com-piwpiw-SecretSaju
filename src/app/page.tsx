        ...
        >
            <form onSubmit={handleSearchSubmit} className="flex items-center gap-3 w-full">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-xs font-black text-white placeholder:text-slate-500 w-full tracking-wider uppercase"
              />
            ...
            <ScrollReveal>
              <div className="flex flex-col sm:flex-row items-center justify-between px-4 gap-4">
                ...
                <div className="flex items-center gap-3 px-4 py-2 ui-chip">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-100">시스템 동기 상태: 최적</span>
                </div>
              </div>
              <motion.div
            ...
            <ScrollReveal direction="down">
              ...
              >
                ...
                <div className="max-w-xl mx-auto space-y-4">
                  ...
                  <div className="flex items-center justify-center gap-2.5 text-[9px] text-slate-500 font-black uppercase tracking-widest opacity-60">
          ...
          >
            ...
            <div className="max-w-xl mx-auto flex flex-col sm:flex-row items-center gap-4">
              ...
              <button
                ...
                disabled={isSharing}
                aria-label="분석 결과 공유"
                className="w-full sm:flex-1 py-5 rounded-2xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-black uppercase tracking-widest text-[10px] shadow-xl shadow-indigo-950/20 transition-all flex items-center justify-center gap-3 active:scale-95"
              >
